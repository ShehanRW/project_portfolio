    ...
    <>
      <Flex h={'15ig'} w={'full'} bg={'brand.900'} position={'fixed'} gap={1} flex={1} >
        ...
        <Flex flex={3} h={"15ig"} w={5} gap={2} justifyContent={'center'} alignItems={'center'}>
          ...
          <Link href='/profile' color={"brand.0"} fontWeight={'500'} fontSize={20} p={2} _hover={{ color: 'brand.50' }} style={{ textDecoration:'none' }}>Profile</Link>
          <Link href='/blog' color={"brand.0"} fontWeight={'500'} fontSize={20} p={2} _hover={{ color: 'brand.50' }} style={{ textDecoration:'none' }}>Blog</Link>
          <Link href='/contact' color={"brand.0"} fontWeight={'500'} fontSize={20} p={2} _hover={{ color: 'brand.50' }} style={{ textDecoration:'none' }}>Contact</Link>
        </Flex>
