'use client'
import { Button, Flex, Input, Textarea, Text, Image } from '@chakra-ui/react'
  ...
  return (
    <>
        <Flex w={900} direction={'column'} m={10} border={'solid 2px'} borderColor={'brand.200'} padding={2} gap={1}>
            ...
            <Image src='#' alt='Project img' w={200}/>
            ...
            <Flex gap={1}>
                <Button bg={'brand.200'} size={'sm'} borderRadius={'none'} w={200}>Select Blog</Button>
