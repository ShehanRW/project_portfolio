    ...
    <>
      ...
      <Flex direction={{base:'column', md:'row'}} >
        ...
        <Flex direction={'column'} m={10}>
          ...
          <Text color={'brand.200'} fontSize={20} fontWeight={10} m={5}>I am interested in software developing, system architectures and coding. I am doing arts, 3D design and video production to youtube as a hobby also. </Text>
